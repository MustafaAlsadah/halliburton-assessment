...
export default function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex w-full max-w-[500px] items-center justify-center overflow-hidden rounded-lg border border-transparent border-2 bg-background p-10"
      ref={containerRef}
    >
